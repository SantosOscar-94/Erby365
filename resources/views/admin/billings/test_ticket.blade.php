...
<body>
    <div class="cabecera">
        <img src="{{ public_path('assets/img/branding/icon-login.png') }}" style="margin-top: 9px;" width="35%" height="7%">
        <p style="font-size: 16px; font-weight: bold; margin-bottom: 0; margin-top: 10px;">MyPeru-Fac</p>
        <p style="font-size: 10.5px; margin-top:0; margin-bottom: 0;">JR MANCO CAPAC 452</p>
        <p style="font-size: 10.5px; margin-top:0; margin-bottom: 0;">JICAMARCA - SAN MARTIN</p>
        <p style="font-size: 14.5px; font-weight: bold; margin-top:0; margin-bottom: 0;">RUC: 20610316990</p>
    ...
    <div class="informacion">
        ...
        <p style="font-size: 11px; margin-top:0; margin-bottom: 0;">OSCAR SANTOS</p>
    ...
    <p style="font-size: 11px; text-align: center; padding: 0px 18px;">GRACIAS POR SU COMPRA.</p>
</div>
