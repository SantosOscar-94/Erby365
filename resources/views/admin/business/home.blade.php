            ...
            <div class="dt-action-buttons text-end">
                <div class="dt-buttons d-inline-flex">
                    <button class="dt-button create-new btn btn-primary btn-gen-json" tabindex="0" type="button">
                        ...
                        <span class="spinner-border spinner-border-sm me-1 d-none text-load-gen" role="status"
                    ...
                    <div class="card-body">
                        ...
                        <form id="form-info" class="form form-vertical">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    <label for="email_accounting">N° Cuenta Detraciones </label>
                                    <input type="text" id="email_accounting" class="form-control" name="email_accounting"
                                        value="{{ $business->cuenta_detraciones }}" />
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="custom-control custom-radio my-50">
                                        <input type="radio" id="beta" name="servidor_sunat"
                                            class="form-check-input" {{ $business->servidor_sunat == 3 ? 'checked' : '' }}
                                            value="3">
                                        <label class="form-checked-label" for="beta">Beta</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="produccion" name="servidor_sunat"
                                            class="form-check-input" {{ $business->servidor_sunat == 1 ? 'checked' : '' }}
                                            value="1">
                                ...
                                <div class="col-12 text-end mb-2">
                                    <button type="button" class="btn btn-primary btn-save-user">
                                        ...
                                        <span class="spinner-border spinner-border-sm me-1 d-none text-saving-user"
                                            role="status" aria-hidden="true"></span>
