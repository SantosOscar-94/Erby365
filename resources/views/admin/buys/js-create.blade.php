        ...
        if (window.usd) {
            ...
            $("input[name='precio_compra']").each(function() {
                ...
                if (!isNaN(precioSoles)) {
                    $(this).val(precioSoles);
                } else{
                    //alert("Error al realizar el cambio de moneda.3")
                }
            });
            ...
            $("span.total").each(function() {
                ...
                if (!isNaN(precioSoles)) {
                    ...
                    alert("Error al realizar el cambio de moneda.4")
                }
            });
            ...
            $("input[name='precio_compra']").each(function() {
                ...
                if (!isNaN(precioSoles)) {
                    ...
                    //alert("Error al realizar el cambio de moneda.1")
                }
            });
            ...
            $("span.total").each(function() {
                ...
                if (!isNaN(precioSoles)) {
                    ...
                    alert("Error al realizar el cambio de moneda.2")
                }
            });
