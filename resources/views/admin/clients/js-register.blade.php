<script>
    $('body').on('click', '.btn-create-client', function()
    {
        ...
        $('#form_save_client #opcional_direccion').addClass('d-none');
        //$('#form_save_client #tipo_documento').select2('destroy');
    });
    ...
    function load_ubigeo1() {
        $.ajax({
            ...
            success: function(r) {
                ...
                //$('#form_save_client select[name="departamento"]').select2('destroy');
    ...
    $('#form_save_client select[name="departamento"]').on('change', function() {
        ...
        $.ajax({
            ...
            success: function(r) {
                ...
                //$('#form_save_client select[name="provincia"]').select2('destroy');
    ...
    $('#form_save_client select[name="provincia"]').on('change', function() {
        ...
        $.ajax({
            ...
            success: function(r) {
                ...
                //$('#form_save_client select[name="distrito"]').select2('destroy');
    ...
    $('body').on('click', '#form_save_client .btn-search-dniruc', function() {
        ...
        $.ajax({
            ...
            success: function(r) {
                ...
                if (dni)
                    $('#form_save_client #opcional_direccion').removeClass('d-none');
            },
            dataType: 'json'
        });
    });

    function active__ubigeo1(ubigeo)
    {
