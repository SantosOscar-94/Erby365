                ...
                <div class="card-body">
                    <form id="form_save_credit_note" class="form form-vertical">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-2 mb-3">
                                <div class="form-group">
                                    <label class="form-label" for="global_discount">Descuento Global</label>
                                    <input type="number" id="global_discount" class="form-control" name="global_discount" value="" disabled>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tbody id="tbody_sale_notes">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="number" name="cant" class="form-control"style="width: 80px;" value="{{(int) $product["cantidad"] }}" data-price="{{ $product["precio_unitario"] }}" data-id="{{ $product["id"] }}" disabled></td>
                                                <td class="text-center"><input type="text" name="price" class="form-control" value="{{ $product["precio_unitario"] }}" data-cant="{{(int) $product["cantidad"] }}" data-id="{{ $product["id"] }}" disabled></td>
                            ...
                            <div class="col-md-12 d-flex justify-content-end -0 p-sm-4">
                                <div id="wrapper_totals" class="invoice-calculations">
                                    <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <span class="fw-medium">S/<span id="grabada">{{ number_format(($factura['exonerada'] + $factura['gravada'] + $factura['inafecta']), 2, ".", "") }}</span></span>
                                        </div>
                                        <div class="d-flex justify-content-between mb-2">
                                            <span class="w-px-100">IGV:</span>
                                            <span class="fw-medium">S/<span id="igv" data-igv="{{$factura['igv']}}">{{ number_format($factura['igv'], 2, ".", "") }}</span></span>
                                        </div>
                                        <hr>
                                        <div class="d-flex justify-content-between">
                                            <span class="w-px-100">Total:</span>
                                            <span class="fw-medium">S/<span id="total" data-total="{{ number_format($factura['total'], 2, ".", "") }}">{{ number_format($factura['total'], 2, ".", "") }}</span></span>
                                    </div>
                                </div>
                            </div>
