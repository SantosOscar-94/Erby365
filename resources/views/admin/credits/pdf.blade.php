...
<body>
    <table class="header">
        <tr>
            ...
            <td class="data-ruc">
                ...
                <div class="name"></div>
                <div class="number">{{ $credit->serie . '-' . $credit->correlativo }}</div>
            </td>
        </tr>
    </table>
    <div class="user">
    ...
    <table class="all">
        <tr>
            <td class="observation">
                <b>OBSERVACIONES:</b>
                <span>{{ $credit->observaciones }}</span>
            </td>
            <td class="all-pay">
                <div class="item">
                    <div class="left">OP. GRAVADAS: S/.</div>
                    <div class="right">{{ number_format(($credit->exonerada + $credit->gravada + $credit->inafecta), 2, '.', '') }}</div>
                </div>
                <div class="item">
                    <div class="left">IGV: S/.</div>
                    <div class="right">{{ $credit->igv }}</div>
                </div>
                <div class="item bold">
                    <div class="left">TOTAL A PAGAR: S/.</div>
                    <div class="right">{{ $credit->total }}</div>
                </div>
            </td>
        </tr>
    </table>
    ...
    <table class="fechas">
        ...
        <div class="item">
            ...
            <div class="right">{{ $credit->fecha_emision }}</div>
        </div>
        <div class="item bold">
            <div class="left">FECHA VENCIMIENTO:</div>
            <div class="right">{{ $credit->fecha_vencimiento  }}</div>
        </div>
    </table>
