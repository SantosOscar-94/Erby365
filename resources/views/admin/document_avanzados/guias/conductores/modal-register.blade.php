<div class="modal fade" id="modalAddDriver" data-bs-backdrop="static" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <form id="form_save_driver" class="modal-content" onsubmit="event.preventDefault()">
            @csrf
            <div class="modal-header">
                <h5 class="modal-title" id="modalAddClientTitle">Registrar Conductor</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <select name="tipo_documento" id="tipo_documento2" class="form-control">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        <label class="form-label" for="licencia">Licencia <small class="text-danger" style="font-size: 12px;"></small></label>
