    ...
    <section class="basic-select2">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Filtros Ventas Vendedor:
                            <div class="text-end mb-4 d-inline p-6 float-end">
                                <a href="{{ route('admin.add_gr_transportista') }}" class="dt-button create-new btn btn-primary waves-effect waves-light btn-create" tabindex="0"><span><i class="ti ti-plus me-sm-1"></i><span class="d-none d-sm-inline-block">Nueva Guia</span></span></a>
                                <button class="dt-button create-new btn btn-primary waves-effect waves-light btn-create" tabindex="0"><span><i class="ti ti-plus me-sm-1"></i><span class="d-none d-sm-inline-block">Generar Comprobante desde multiples guias</span></span></button>
                            </div>
                        </h5>
                        <form id="form-sales-seller1" method="POST" class="form form-vertical"
...
@endsection
@section('scripts')
    @include('admin.document_avanzados.guias.gr_transportista.js-home')
    @include('admin.document_avanzados.guias.gr_transportista.js-datatable')
@endsection
