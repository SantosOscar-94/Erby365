    ...
    <section class="basic-select2">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Filtros Transportistas:
                            <div class="text-end mb-4 d-inline p-6 float-end">
                                <button class="dt-button btn btn-primary waves-effect waves-light btn-create-client" tabindex="0"><span><i class="ti ti-plus me-sm-1"></i><span class="d-none d-sm-inline-block">Nuevo Transportista</span></span></button>
                            </div>
                        </h5>
                        <form id="form-salles-products1" method="POST" class="form form-vertical"
                                    ...
                                    <table class="table table-sm mb-0 fs--1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" width="10%">Tipo de documento</th>
                                                <th class="text-center" width="10%">Número</th>
                                                <th class="text-center" width="10%">MTC</th>
...
@endsection
@section('scripts')
    @include('admin.document_avanzados.guias.transportistas.js-home')
@endsection
