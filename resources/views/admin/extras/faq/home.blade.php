          ...
          <div class="accordion" id="accordionExample">
            <div class="card accordion-item active">
              ...
              <div id="accordionOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                <div class="accordion-body" style="text-align: justify"> No, no cobramos por cada actualizaci&oacute;n. En Erby365, las actualizaciones son parte de nuestro compromiso de mejorar constantemente nuestro software y brindar la mejor experiencia a nuestros usuarios. Las actualizaciones son gratuitas y se proporcionan de forma regular para mantener el software actualizado y seguro.
                </div>
              </div>
            </div>
