          ...
          <div class="col-lg mb-md-0 mb-4">
            <div class="card border rounded shadow-none">
              <div class="card-body">
                ...
                <a target="_blank" class="btn btn-label-success d-grid w-100 waves-effect" href="https://api.whatsapp.com/send?phone=51900422610&text=Me interesa migrar a la suscripción Básica.">Ir con el administrador</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg mb-md-0 mb-4">
            <div class="card border shadow-none">
              <div class="card-body position-relative">
                ...
                <a target="_blank" class="btn btn-primary d-grid w-100 waves-effect waves-light" href="https://api.whatsapp.com/send?phone=51900422610&text=Me interesa migrar a la suscripción Standard.">Ir con el administrador</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg">
            <div class="card border rounded shadow-none">
              <div class="card-body">
                ...
                <a target="_blank" class="btn btn-label-primary d-grid w-100 waves-effect" href="https://api.whatsapp.com/send?phone=51900422610&text=Me interesa migrar a la suscripción Premiun.">Ir con el administrador</a>
              </div>
            </div>
          </div>
        </div>
