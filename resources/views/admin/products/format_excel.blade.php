        ...
        <table id="table_items">
                <thead id="thead_items" style="font-size: 12px;">
                    <tr>
                        ...
                        <th style="font-weight: bold; border: 1px solid #dee2e6; text-align: center;">categoria</th>
                        ...
                        <th style="font-weight: bold; border: 1px solid #dee2e6; text-align: center;">precio_venta_por_mayor</th>
                        <th style="font-weight: bold; border: 1px solid #dee2e6; text-align: center;">precio_venta_distribuidor</th>
                        <th style="font-weight: bold; border: 1px solid #dee2e6; text-align: center;">stock</th>
                        <th style="font-weight: bold; border: 1px solid #dee2e6; text-align: center;">tienda</th>
                        <th style="font-weight: bold; border: 1px solid #dee2e6; text-align: center;">fecha_produccion</th>
                ...
                <tbody>
                    @foreach ($filas as $index => $item)
                        <tr>
                            ...
                            <td style="border: 1px solid #dee2e6; text-align: center;" data-format="0.00">{{ $item["precio_venta_por_mayor"] }}</td>
                            <td style="border: 1px solid #dee2e6; text-align: center;" data-format="0.00">{{ $item["precio_venta_distribuidor"] }}</td>
                            <td style="border: 1px solid #dee2e6; text-align: center;">{{$item['stock']}}</td>
                            <td style="border: 1px solid #dee2e6; text-align: center;">{{$item['tienda']}}</td>
